...
function createTutorial() {
	...
	// index 1: 비토벤의 위치
	tutorialArray.push(new Tutorial(147, 407, 40, 650,
	...
	// index 5: 생명력
	tutorialArray.push(new Tutorial(83, 70, 40, 650,
	...
	tutorialArray.push(new Tutorial(714, 763, 40, 30, 
...
function showTutorial(tutorialIndex) {
	...
	rhythmi = game.add.sprite(tutorialArray[tutorialIndex].rhythmiX, tutorialArray[tutorialIndex].rhythmiY, 'rhythmi');
		// 시작과 끝은 리드미를 크게 보여준다
		if (tutorialIndex == 0 || tutorialIndex == tutorialArray.length-1) {rhythmi.smoothed = false; rhythmi.scale.set(5);}
